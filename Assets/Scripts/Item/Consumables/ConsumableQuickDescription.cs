...
public class ConsumableQuickDescription : MonoBehaviour
{
    ...
    public void SetText(Consumable consumable)
    {
        //効果とタグの情報を文字列に変換してセット
        descriptionText.text = effectTagToText.ConvertToText(consumable.Effects, new List<CardTagDefine>()); ;
